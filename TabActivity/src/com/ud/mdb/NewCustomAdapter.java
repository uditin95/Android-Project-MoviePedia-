...
public class NewCustomAdapter extends BaseAdapter{
	...
	public NewCustomAdapter(Activity Context, List<TopRatedData> moviesList){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			_holder.avg = (TextView) convertView.findViewById(R.id.av);
			convertView.setTag(_holder);
			_holder.votes = (TextView) convertView.findViewById(R.id.album_txt_03);
		} else {
