...
public class PopularMovies extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mainlist = (ListView) findViewById(R.id.popList);
	...
	private void setTopRatedList() {
		...
		try {
			...
			dialog = ProgressDialog.show(PopularMovies.this, "Fetching Movies",
			...
			new Thread(new Runnable() {
				...
				public void run() {
					// TODO Auto-generated method stub
					JSONData h = new JSONData(PopularMovies.this);
					try {
						if (Utlity.isOnline(PopularMovies.this)) {
							
							
							topRatedList = h.getAlbumList("1","popular");
							...
							if (topRatedList == null) {
								...
								mHandler.post(new Runnable() {
									@Override
									public void run() {
										Toast.makeText(PopularMovies.this,	"No Data Found",Toast.LENGTH_LONG).show();
										if (dialog != null && dialog.isShowing())
											dialog.dismiss();
										loadingMore = false;
										mainlistAdapter = new NewCustomAdapter(PopularMovies.this,topRatedList);
...
mainlist.setOnScrollListener(new OnScrollListener() {
											...
											public void onScroll(AbsListView view, int firstVisibleItem,
												...
												if (!Utlity.isOnline(PopularMovies.this)) {
													Toast.makeText(PopularMovies.this,"No Network Detected.", Toast.LENGTH_LONG).show();
													int fvcount = mainlist.getFooterViewsCount();
													for (int f = 0; f < fvcount; f++) {
														mainlist.removeFooterView(footer);
													}
								...
								mainlist.setOnItemClickListener(new OnItemClickListener() {
									...
									public void onItemClick(
										...
										if(position < topRatedList.size()){
											Intent i = new Intent(PopularMovies.this,MovieDetail.class);
	...
	Runnable getDataOnListEnd = new Runnable() {
		...
		public void run() {
			// TODO Auto-generated method stub
			loadingMore = true;
			JSONData data = new JSONData(PopularMovies.this);
			try {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.popular_movies, menu);
		return true;
	}
